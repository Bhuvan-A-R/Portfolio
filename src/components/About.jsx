...
const About = () => {
  ...
  const personalInfo = [
    ...
    { icon: <FiCalendar />, label: '20 years old' },
            ...
            <div className="tab-content">
              {activeTab === 'personal' && (
                ...
                >
                  ...
                  <p className="subtitle">A curious person, who wants to know how things work.</p>
                  ...
                  <div className="languages">
                    <h4 className="text-primary font-bold mb-2">Language Skills</h4>
